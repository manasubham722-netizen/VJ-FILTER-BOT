...
# Bot information
SESSION = environ.get('SESSION', 'MoviesBot')
API_ID = int(environ.get('API_ID', '31190505'))
API_HASH = environ.get('API_HASH', '19ee4edba247de5977bed96d1129b6b2')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6240554147').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6240554147').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003657766368'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002585670955').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002535991041') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://subhammana832_db_user:subham832752@cluster0.nlk34di.mongodb.net/?appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+zVjhTE2WyRFjNmFl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+YeYUfkpUcPs3MTNl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Helloes_ygh') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/subham832752')
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '8ec98008310016c6c90339b8c5e4b4f216a80df9')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://youtu.be/VQhuPEOffMw?si=ULrqlT49VyHDNchV')
